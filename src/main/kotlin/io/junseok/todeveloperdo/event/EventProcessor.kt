...
class EventProcessor(
    ...
    fun closeIssueWithReadMe(member: Member, todoList: MemberTodoList, state: String) {
        todoList.issueNumber?.let {
            issueEventProcessor.close(member, todoList.issueNumber!!, state)
